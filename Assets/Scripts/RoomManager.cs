...
public class RoomManager : MonoBehaviourPunCallbacks
{
    ...
    {
        // Prefill values
        playerNameField.text = "Kartikeya";
        roomCodeField.text = "VRCLASS2026";
        passwordField.text = "gitam123";
    ...
    void OnCreateClicked()
    {
        ...
        var options = new RoomOptions
        {
            ...
            CustomRoomProperties =
                ...
                {
                    { PASSWORD_PROP_KEY, passwordField.text.Trim() }
                },
            CustomRoomPropertiesForLobby =
                new string[] { PASSWORD_PROP_KEY }
        };
    ...
    void OnJoinClicked()
    {
        ...
        StartCoroutine(
            JoinWithPasswordCheck(
                roomCodeField.text.Trim(),
    ...
    IEnumerator JoinWithPasswordCheck(string roomCode, string entered)
    {
        ...
        if (target != null &&
            target.CustomProperties.ContainsKey(PASSWORD_PROP_KEY))
        {
            string stored =
                target.CustomProperties[PASSWORD_PROP_KEY].ToString();
